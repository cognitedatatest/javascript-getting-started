import { Icon, Modal, Table as Table$1, Collapse, Spin, Tabs, notification as notification$1, Select, Form, Input as Input$1, Button, Tree, Checkbox, Tag as Tag$1 } from 'antd';
import React, { Component } from 'react';
import styled, { ThemeProvider as ThemeProvider$1 } from 'styled-components';
import { Assets, ThreeD, Datapoints, TimeSeries, Events } from '@cognite/sdk';
...
function getAssetList(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, Assets.list({
                        name: query,
                        fuzziness: fuzziness,
                    })];
                case 1:
...
var DL = styled('dl')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n  text-align: left;\n\n  dl,\n  dt {\n    border: 1px solid #e8e8e8;\n    border-bottom: unset;\n    padding: 16px;\n    width: 50%;\n    margin: 0;\n    background-color: white;\n  }\n\n  dl:last-of-type,\n  dt:last-of-type {\n    border-bottom: 1px solid #e8e8e8;\n  }\n\n  dt {\n    border-right: unset;\n    font-weight: 500;\n  }\n\n  @media only screen and (max-width: 840px) {\n    dl,\n    dt {\n      width: 100%;\n      border: 1px solid #e8e8e8;\n      border-bottom: unset;\n    }\n\n    dt {\n      background-color: #ececec;\n    }\n\n    dt:last-of-type {\n      border-bottom: unset;\n    }\n  }\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n  text-align: left;\n\n  dl,\n  dt {\n    border: 1px solid #e8e8e8;\n    border-bottom: unset;\n    padding: 16px;\n    width: 50%;\n    margin: 0;\n    background-color: white;\n  }\n\n  dl:last-of-type,\n  dt:last-of-type {\n    border-bottom: 1px solid #e8e8e8;\n  }\n\n  dt {\n    border-right: unset;\n    font-weight: 500;\n  }\n\n  @media only screen and (max-width: 840px) {\n    dl,\n    dt {\n      width: 100%;\n      border: 1px solid #e8e8e8;\n      border-bottom: unset;\n    }\n\n    dt {\n      background-color: #ececec;\n    }\n\n    dt:last-of-type {\n      border-bottom: unset;\n    }\n  }\n"])));
var NoData = styled('p')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  border: 1px solid #e8e8e8;\n  padding: 16px;\n  text-align: center;\n"], ["\n  border: 1px solid #e8e8e8;\n  padding: 16px;\n  text-align: center;\n"])));
var DescriptionList = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        description && (React.createElement("p", { id: description.descriptionId }, description.descriptionText)),
        arrayValues.length >= 1 ? (React.createElement(DL, { style: props.styles, "aria-describedby": description ? description.descriptionId : '' }, arrayValues.map(function (valSet) { return (React.createElement(React.Fragment, { key: valSet.key || valSet.name },
            React.createElement("dt", null, valSet.name),
            React.createElement("dl", null, valSet.value))); }))) : (React.createElement(NoData, null, "No data"))));
};
...
var AssetEventsPanel = /** @class */ (function (_super) {
    ...
    function AssetEventsPanel(props) {
        ...
        _this.renderEventDetails = function (event) { return (React.createElement(EventDetails, { key: "event-detail" },
            React.createElement("div", { key: "event-type" },
                React.createElement("strong", null,
                    event.type,
                    ","),
                " ",
                event.subtype),
            event.description && (React.createElement("div", { className: "description" }, event.description)),
            React.createElement("div", { key: "event-time", className: "times" },
                React.createElement("span", null, event.start),
                React.createElement("span", null,
                    React.createElement(Icon, { type: "right" })),
                React.createElement("span", { style: { textAlign: 'right' } }, event.end)))); };
        _this.renderEventMetadata = function (event) { return (React.createElement(EventMetadataList, { key: "event-metadata" }, Object.keys(event.metadata || {}).map(function (key) { return (React.createElement("div", { key: key, className: "event-metadata" },
            React.createElement("strong", null, key),
            " ",
            React.createElement("br", null),
            React.createElement("span", null, event.metadata && event.metadata[key]))); }))); };
        _this.mapEvent = function (event) { return (__assign({}, event, { typeAndSubtype: (React.createElement("span", null,
                React.createElement("strong", { style: { display: 'block' } }, event.type),
                React.createElement("span", { style: { fontSize: 12, opacity: 0.8 } }, event.subtype))), description: event.description || 'No description', start: typeof event.startTime === 'number'
    ...
    AssetEventsPanel.prototype.getTableComponents = function () {
        ...
        return {
            body: {
                row: function (props) {
                    return (React.createElement(StyledRow, { style: styles && styles.tableRow, onClick: function () { return _this.onEventClick(props['data-row-key']); } }, props.children));
                },
                cell: function (props) {
                    return (React.createElement(StyledCell, { style: styles && styles.tableCell }, props.children));
                },
            },
        };
    };
    AssetEventsPanel.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(StyledTable, { key: "styleTable", columns: columns, dataSource: events.map(this.mapEvent), rowKey: "id", showHeader: showHeader, pagination: pagination, scroll: scroll, bordered: bordered, components: this.getTableComponents(), style: styles && styles.table }),
            !!selectedEvent && (React.createElement(Modal, { key: "Modal", visible: !!selectedEvent, footer: null, onCancel: function () { return _this.setState({ selectedEvent: null }); } }, !!selectedEvent && [
...
var StyledTable = styled(Table$1)(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject([""], [""])));
var StyledRow = styled.tr(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  background: white;\n  cursor: pointer;\n  &:nth-child(2n) {\n    background: #fafafa;\n  }\n"], ["\n  background: white;\n  cursor: pointer;\n  &:nth-child(2n) {\n    background: #fafafa;\n  }\n"])));
var StyledCell = styled.td(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  max-width: 500px;\n"], ["\n  max-width: 500px;\n"])));
var EventDetails = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  .description {\n    font-size: 18px;\n    padding-top: 16px;\n  }\n  .times {\n    display: flex;\n    justify-content: space-between;\n    padding-top: 16px;\n  }\n"], ["\n  .description {\n    font-size: 18px;\n    padding-top: 16px;\n  }\n  .times {\n    display: flex;\n    justify-content: space-between;\n    padding-top: 16px;\n  }\n"])));
var EventMetadataList = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  margin-top: 32px;\n  max-height: calc(100vh - 400px);\n  overflow: auto;\n  .event-metadata {\n    padding: 16px;\n    &:nth-child(2n) {\n      background: #fbfbfb;\n    }\n  }\n"], ["\n  margin-top: 32px;\n  max-height: calc(100vh - 400px);\n  overflow: auto;\n  .event-metadata {\n    padding: 16px;\n    &:nth-child(2n) {\n      background: #fbfbfb;\n    }\n  }\n"])));
...
var DocumentTable = /** @class */ (function (_super) {
    ...
    function DocumentTable() {
        ...
        _this.renderDocument = function (category, description) { return function (document, i, all) {
            ...
            return (React.createElement(LinkContainer, { key: document.id, style: styles && styles.fileContainer },
                React.createElement(LinkStyle, { key: document.id, "data-test-id": "file-name", onClick: function () {
                ...
                React.createElement(TextContainerTop, { "data-test-id": "document-title", style: styles && styles.fileTitle }, getDocumentTitle(document.metadata, documentTitleField))));
        }; };
        return _this;
    }
    DocumentTable.prototype.render = function () {
        ...
        if (!categories.length) {
            return (React.createElement(NoDocuments, { "data-test-id": "no-documents" }, "" + (noDocumentsSign
                ? noDocumentsSign
                : 'No documents linked to this asset')));
        }
        return (React.createElement(React.Fragment, null,
            React.createElement(TableWrapper, null,
                React.createElement(CollapseContainer, __assign({}, collapseProps), categories.map(function (category, i) {
                    ...
                    return (React.createElement(PanelWrapper, { header: header, key: category, delimiter: prioritizedCount === i + 1 &&
...
var TableWrapper = styled.div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  width: 100%;\n  justify-content: center;\n  display: flex;\n"], ["\n  width: 100%;\n  justify-content: center;\n  display: flex;\n"])));
var LinkContainer = styled.div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  display: flex;\n  margin: 10px 0;\n  white-space: nowrap;\n"], ["\n  display: flex;\n  margin: 10px 0;\n  white-space: nowrap;\n"])));
var CollapseContainer = styled(Collapse)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  background-color: green;\n  width: 100%;\n"], ["\n  background-color: green;\n  width: 100%;\n"])));
var TextContainerTop = styled.div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  width: 100%;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  text-transform: uppercase;\n"], ["\n  width: 100%;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  text-transform: uppercase;\n"])));
var PanelWrapper = styled(Panel)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  text-align: left;\n  ", "\n"], ["\n  text-align: left;\n  ",
    "\n"])), function (_a) {
    var delimiter = _a.delimiter;
    return delimiter ? 'border-bottom: 2px solid #CFCFCF !important;' : '';
});
var LinkStyle = styled.a(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  font-size: 1.125em;\n  margin-right: 10px;\n"], ["\n  font-size: 1.125em;\n  margin-right: 10px;\n"])));
var NoDocuments = styled.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  padding: 16px;\n"], ["\n  padding: 16px;\n"])));
...
var getTimeSeries = function (id) {
    ...
    var promise = TimeSeries.retrieve(id).then(function (timeserie) {
...
var getRawDataPoints = function (_a) {
    ...
    return Datapoints.retrieve(id, { start: start, end: end, limit: limit }).then(function (data) {
    ...
    TimeseriesChart.prototype.render = function () {
        ...
        var griffSeries = series
            ? series.map(function (s) { return (__assign({}, s, { id: s.id, color: s.color ||
                    ...
                    getColorByString(s.id.toString()), yAxisDisplayMode: s.yAxisDisplayMode || AxisDisplayMode[yAxisDisplayMode], hidden: s.hidden || hiddenSeries[s.id], yAccessor: s.yAccessor || yAccessor, y0Accessor: s.y0Accessor || y0Accessor, y1Accessor: s.y1Accessor || y1Accessor })); })
        ...
        return (griffSeries.length !== 0 && (React.createElement(Spin, { spinning: !loaded },
            React.createElement(Wrapper, { style: styles && styles.container },
                React.createElement(DataProvider, { defaultLoader: cogniteloader, onFetchData: this.onFetchData, pointsPerSeries: pointsPerSeries, series: griffSeries, collections: __spread(new Set(Object.values(collections))).map(function (unit) { return ({
                        id: unit,
                        ...
                        : 0 },
                    React.createElement(LineChart, { zoomable: zoomable, crosshair: crosshair, annotations: annotations, contextChart: {
                            visible: contextChart,
                            height: 100,
                            isDefault: true,
                        }, height: height, width: width, ruler: ruler, yAxisFormatter: decimalTickFormatter, yAxisPlacement: AxisPlacement[yAxisPlacement], xAxisHeight: xAxisHeight, onMouseMove: onMouseMove, onMouseOut: onMouseOut, onBlur: onBlur }))))));
    };
...
var TimeseriesMetaInfo = function (_a) {
    ...
    return (React.createElement(CollapseContainer$1, null,
        React.createElement(PanelWrapper$1, { header: 'Metadata', key: 'timeseries-metadata' },
            React.createElement(Table, null, metaList.map(function (entry) { return (React.createElement(TableRow, { key: entry.property },
                React.createElement(TableProperty, null, entry.property),
                React.createElement(TableValue, null, entry.value))); })))));
};
var Table = styled.div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  display: table;\n"], ["\n  display: table;\n"])));
var TableRow = styled.div(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  display: table-row;\n"], ["\n  display: table-row;\n"])));
var TableProperty = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  display: table-cell;\n  font-weight: bold;\n  min-width: 200px;\n"], ["\n  display: table-cell;\n  font-weight: bold;\n  min-width: 200px;\n"])));
var TableValue = styled.div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: table-cell;\n  padding-left: 10px;\n"], ["\n  display: table-cell;\n  padding-left: 10px;\n"])));
var PanelWrapper$1 = styled(Collapse$1.Panel)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  text-align: left;\n"], ["\n  text-align: left;\n"])));
var CollapseContainer$1 = styled(Collapse$1)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  && {\n    margin-top: 14px;\n    min-width: 600px;\n    max-width: 800px;\n  }\n"], ["\n  && {\n    margin-top: 14px;\n    min-width: 600px;\n    max-width: 800px;\n  }\n"])));
        ...
        _this.getLatestDatapoint = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connectPromiseToUnmountState(this, Datapoints.retrieveLatest(this.props.timeseriesName))];
                    case 1:
                        datapoint = _a.sent();
                        if (!datapoint) {
                            this.setState({
    ...
    TimeseriesValue.prototype.render = function () {
        return (React.createElement(Container, null,
            React.createElement(Value, null,
                this.state.value,
                this.props.unit && React.createElement("sup", null, this.props.unit)),
            React.createElement(Description, null, this.props.timeseriesDescription)));
    };
...
var Value = styled.div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  font-size: 14px;\n  color: ", ";\n"], ["\n  font-size: 14px;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var Description = styled.div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  font-size: 12px;\n  color: ", ";\n"], ["\n  font-size: 12px;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var TimeseriesChartMetaPure = /** @class */ (function (_super) {
    ...
    TimeseriesChartMetaPure.prototype.render = function () {
        ...
        return (React.createElement(Container$1, null,
            showDescription && React.createElement(Description$1, null, timeseries.description),
            showPeriods && (React.createElement(CenterWrapper, null,
                React.createElement(Radio.Group, { value: timePeriod, onChange: this.handlePeriodChange }, Object.keys(timeScales).map(function (key) { return (React.createElement(Radio.Button, { key: key, value: key }, timeScales[key].number + " " + timeScales[key].unit)); })))),
            showChart && (React.createElement(TimeseriesChart, { timeseriesIds: [timeseries.id], liveUpdate: liveUpdate, updateIntervalMillis: updateIntervalMillis, startTime: basePeriod.startTime, endTime: basePeriod.endTime })),
            showDatapoint && (React.createElement(CenterWrapper, null,
                React.createElement(TimeseriesValue, { timeseriesName: timeseries.name, timeseriesDescription: timeseries.description, liveUpdate: liveUpdate, updatePeriodMillis: updateIntervalMillis, unit: timeseries.unit }))),
            showMetadata && (React.createElement(CenterWrapper, null,
                React.createElement(TimeseriesMetaInfo, { metaInfo: timeseries.metadata || {} })))));
    };
...
var Description$1 = styled.p(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  text-align: left;\n"], ["\n  text-align: left;\n"])));
var CenterWrapper = styled.div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  width: 100%;\n  justify-content: center;\n  display: flex;\n"], ["\n  width: 100%;\n  justify-content: center;\n  display: flex;\n"])));
...
var TimeseriesPanel = /** @class */ (function (_super) {
    ...
    TimeseriesPanel.prototype.render = function () {
        ...
        if (!timeseries || !timeseries.length) {
            return (React.createElement(NoTimeseries, { "data-test-id": "no-timeseries" }, "" + strings.noTimeseriesSign));
        }
        return (React.createElement(React.Fragment, null,
            React.createElement(TableWrapper$1, null,
                React.createElement(CollapseContainer$2, null, timeseries &&
                    timeseries.map(function (ts) { return (React.createElement(PanelWrapper$2, { header: ts.name, key: ts.id.toString() },
                        React.createElement(TimeseriesChartMetaPure, __assign({ key: ts.id, timeseries: ts }, rest)))); })))));
    };
...
var PanelWrapper$2 = styled(Collapse.Panel)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  text-align: left;\n"], ["\n  text-align: left;\n"])));
var TableWrapper$1 = styled.div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  width: 100%;\n  justify-content: center;\n  display: flex;\n"], ["\n  width: 100%;\n  justify-content: center;\n  display: flex;\n"])));
var CollapseContainer$2 = styled(Collapse)(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var NoTimeseries = styled.div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  padding: 16px;\n"], ["\n  padding: 16px;\n"])));
var templateObject_1$7, templateObject_2$6, templateObject_3$5, templateObject_4$3;

var SpinContainer = styled.div(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  align-items: center;\n  justify-content: center;\n"], ["\n  display: flex;\n  width: 100%;\n  align-items: center;\n  justify-content: center;\n"])));
...
var AssetMeta = /** @class */ (function (_super) {
    ...
    function AssetMeta(props) {
        ...
        _this.tabStyle = function (tab, contentLen) {
            return contentLen > 0 ? (React.createElement("span", null, tab)) : (React.createElement(EmptyPane, { style: _this.props.styles && _this.props.styles.emptyTab },
                "(",
                tab,
                ")"));
        };
    ...
    AssetMeta.prototype.renderDetails = function () {
        ...
        return (React.createElement(TabPane, { tab: this.tabStyle('Details', Object.keys(asset.metadata).length), key: "details" },
            React.createElement(DescriptionList, { valueSet: asset.metadata, styles: styles && styles.details })));
    };
    AssetMeta.prototype.renderTimeseries = function () {
        ...
        return (React.createElement(TabPane, { tab: this.tabStyle('Timeseries', timeseries && timeseries.timeseries ? timeseries.timeseries.length : 0), key: "timeseries" },
            React.createElement(TimeseriesPanel, __assign({}, timeseries))));
    };
    AssetMeta.prototype.renderDocuments = function () {
        ...
        return (React.createElement(TabPane, { tab: this.tabStyle('Documents', docs.docs.length), key: "documents" },
            React.createElement(DocumentTable, __assign({}, docs, { styles: styles && styles.documents }))));
    };
    AssetMeta.prototype.renderEvents = function () {
        ...
        return (React.createElement(TabPane, { tab: this.tabStyle('Events', assetEvents.events ? assetEvents.events.length : 0), key: "events" },
            React.createElement(AssetEventsPanel, __assign({}, assetEvents, { styles: styles && styles.events }))));
    };
    AssetMeta.prototype.render = function () {
        ...
        if (isLoading) {
            return (React.createElement(SpinContainer, null,
                React.createElement(Spin, null)));
        }
        var tab = propsTab === 'documents' || propsTab === 'events' ? propsTab : 'details';
        return asset ? (React.createElement(React.Fragment, null,
            React.createElement("div", { style: styles && styles.header },
                React.createElement("h3", null, asset.name ? asset.name : asset.id),
                asset.description && React.createElement("p", null, asset.description)),
            React.createElement(Tabs, { defaultActiveKey: tab, onChange: onPaneChange },
                this.renderDetails(),
                this.renderTimeseries(),
                this.renderDocuments(),
                this.renderEvents()))) : (React.createElement("p", null, "no Asset"));
    };
    return AssetMeta;
}(React.Component));
...
var notification = function (_a) {
    ...
    notification$1[type](__assign({ message: message, key: message, description: description }, props));
};
var ocrError = {
...
var SpinContainer$1 = styled(Spin)(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  position: absolute !important;\n  background-color: ", ";\n  z-index: 100;\n\n  &:before {\n    content: '';\n    display: inline-block;\n    height: 100%;\n    vertical-align: middle;\n  }\n"], ["\n  width: 100%;\n  height: 100%;\n  position: absolute !important;\n  background-color: ", ";\n  z-index: 100;\n\n  &:before {\n    content: '';\n    display: inline-block;\n    height: 100%;\n    vertical-align: middle;\n  }\n"])), function (_a) {
...
function LoadingOverlay(_a) {
    ...
    if (isLoading) {
        return (React.createElement(SpinContainer$1, { delay: delay, size: size, backgroundcolor: backgroundColor }));
    }
    return null;
}
var templateObject_1$9;

var StyledVideo = styled.video(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  background: rgba(0, 0, 0, 0.5);\n  width: 100%;\n  height: 100%;\n"], ["\n  background: rgba(0, 0, 0, 0.5);\n  width: 100%;\n  height: 100%;\n"])));
...
var Webcam = /** @class */ (function (_super) {
    ...
    Webcam.prototype.render = function () {
        ...
        return (React.createElement(StyledVideo, { autoPlay: true, muted: this.props.audio, className: this.props.className, style: __assign({}, videoStyles), ref: function (ref) {
                _this.video = ref;
                if (setRef) {
                    setRef(ref);
                }
...
var Wrapper$1 = styled.img(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  width: 100%;\n  max-width: 100%;\n  position: absolute;\n  min-width: 150px;\n  top: 50%;\n  transform: translate(0, -50%);\n"], ["\n  width: 100%;\n  max-width: 100%;\n  position: absolute;\n  min-width: 150px;\n  top: 50%;\n  transform: translate(0, -50%);\n"])));
function WebcamScreenshot(_a) {
    var src = _a.src, _b = _a.className, className = _b === void 0 ? '' : _b;
    return (React.createElement(Wrapper$1, { src: "data:image/png;base64," + src, alt: "Captured from webcam", id: "freezeFrame", className: className }));
}
var templateObject_1$b;

var CameraButton = styled.button(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  position: absolute;\n  top: 50%;\n  left: 20px;\n  border-radius: 100%;\n  width: 75px;\n  height: 75px;\n  outline: none;\n  transform: translateY(-50%);\n  border: 1px solid #fff;\n  box-sizing: border-box;\n  cursor: pointer;\n  opacity: .9\n  font-weight: 600;\n  :hover {\n    opacity: 1;\n  }\n"], ["\n  position: absolute;\n  top: 50%;\n  left: 20px;\n  border-radius: 100%;\n  width: 75px;\n  height: 75px;\n  outline: none;\n  transform: translateY(-50%);\n  border: 1px solid #fff;\n  box-sizing: border-box;\n  cursor: pointer;\n  opacity: .9\n  font-weight: 600;\n  :hover {\n    opacity: 1;\n  }\n"])));
var Wrapper$2 = styled.div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  left: 0;\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n"], ["\n  left: 0;\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n"])));
var defaultStrings = {
    reset: 'Reset',
};
function WebcamScanner(_a) {
    ...
    return (React.createElement(Wrapper$2, null,
        React.createElement(LoadingOverlay, { size: 'large', isLoading: isLoading }),
        imageSrc && React.createElement(WebcamScreenshot, { src: imageSrc }),
        React.createElement(Webcam, { audio: false, setRef: setRef, className: "camera", onError: onError }),
        !isLoading &&
            (button ? (button(onCaptureClick, imageSrc)) : (React.createElement(CameraButton, { onClick: onCaptureClick, "data-test-id": "scanner-camera-button", style: styles && styles.button }, imageSrc ? resultStrings.reset : '')))));
}
...
var AssetScanner = /** @class */ (function (_super) {
    ...
    AssetScanner.prototype.render = function () {
        ...
        return (React.createElement(Wrapper$3, null,
            React.createElement(WebcamScanner, { isLoading: isLoading, imageSrc: scannedImageSrc, capture: this.captureBound, setRef: this.setRefBound, onReset: this.resetSearchBound, strings: strings, styles: styles, onError: onError, button: button })));
    };
...
function getRootAssetList() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Assets.list({ depth: 0 })];
                case 1:
                    apiAssets = _a.sent();
...
var RootAssetSelect = /** @class */ (function (_super) {
    ...
    RootAssetSelect.prototype.render = function () {
        ...
        return assets === null || !assets.length ? (React.createElement(Select, { value: 0, className: className, dropdownMatchSelectWidth: false, loading: true },
            React.createElement(Select.Option, { key: "global:loading", value: 0 }, loading))) : (React.createElement(Select, { value: current, className: className, onChange: this.onSelectAsset, dropdownMatchSelectWidth: false, style: styles && styles.select },
            allowAll && (React.createElement(Select.Option, { key: "all", value: 0 }, all)),
            assets.map(function (asset) { return (React.createElement(Select.Option, { key: asset.id, value: asset.id }, asset.description || asset.name || asset.id)); })));
    };
...
var SearchForm = function (_a) {
    ...
    var onAddMetadata = function () {
        ...
        var nextKeys = __spread(keys, [{ id: v4(), key: '', value: '' }]);
        form.setFieldsValue({
            metadata: nextKeys,
        });
    };
    ...
    getFieldDecorator('metadata', {
        initialValue: [{ id: v4(), key: '', value: '' }],
    });
    var metadata = getFieldValue('metadata').length === 0
        ? [{ id: v4(), key: '', value: '' }]
        : getFieldValue('metadata');
    var metadataFields = metadata.map(function (data, index) { return (React.createElement(Form.Item, __assign({}, (index === 0 ? formItemLayout : formItemLayoutWithoutLabel), { label: index === 0 ? metadataLabel : '', required: false, key: data.id }),
        React.createElement(Input$1.Group, { compact: true, style: { display: 'flex' } },
            React.createElement(Input$1, { className: "meta-key " + data.id, style: { width: '45%', borderRight: 0 }, placeholder: metadataKey, value: data.key, onPressEnter: pressEnter, onChange: onChangeInput('key', index) }),
            React.createElement(Input$1, { style: {
                    width: '10%',
                    borderLeft: 0,
                    pointerEvents: 'none',
                    backgroundColor: '#fff',
                }, value: ":", disabled: true }),
            React.createElement(Input$1, { className: "meta-value " + data.id, style: { width: '45%', borderLeft: 0 }, value: data.value, placeholder: metadataValue, onPressEnter: pressEnter, onChange: onChangeInput('value', index) }),
            metadata.length > 1 ? (React.createElement(Icon, { type: "minus-circle-o", style: {
                    position: 'absolute',
                    right: -32,
                    top: '50%',
                    transform: 'translateY(-50%)',
                }, onClick: function () { return onRemoveMetadata(data.id); } })) : null))); });
    return (React.createElement(Form, { layout: "horizontal", onSubmit: submit, style: styles && styles.container },
        React.createElement(Form.Item, __assign({ label: nameField }, formItemLayout), getFieldDecorator('name')(React.createElement(Input$1, { className: "name", name: "name", maxLength: 50, placeholder: nameField, onPressEnter: pressEnter }))),
        React.createElement(Form.Item, __assign({ label: descriptionField }, formItemLayout), getFieldDecorator('description')(React.createElement(Input$1, { className: "description", name: "description", maxLength: 500, placeholder: descriptionField, onPressEnter: pressEnter }))),
        metadataFields,
        React.createElement(Form.Item, __assign({}, formItemLayoutWithoutLabel),
            React.createElement(Button, { htmlType: "button", type: "dashed", className: "add-more-metadata", onClick: onAddMetadata, style: __assign({ width: '100%' }, (styles && styles.addMoreMetadataButton)) },
                React.createElement(Icon, { type: "plus", style: { marginRight: 8 } }),
                addMetadata)),
        onSubmit && (React.createElement(Form.Item, __assign({}, formItemLayoutWithoutLabel),
            React.createElement(Button, { htmlType: "submit", className: "submit", type: "primary", style: { float: 'right' } }, search)))));
};
var SearchFormHOC = Form.create({
    name: 'asset-search',
...
var InputGroup = styled(Input$1.Group)(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  display: flex !important;\n  flex-grow: 1;\n  overflow: visible;\n  position: relative;\n\n  > span {\n    z-index: 1;\n  }\n"], ["\n  display: flex !important;\n  flex-grow: 1;\n  overflow: visible;\n  position: relative;\n\n  > span {\n    z-index: 1;\n  }\n"])));
var ChangeSearchButton = styled(function (props) { return (React.createElement(Button, __assign({}, props))); })(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var RootAssetSelectStyled = styled(RootAssetSelect)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  width: 35%;\n"], ["\n  width: 35%;\n"])));
var LiveSearchWrapper = styled.div(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 100%;\n  left: 0px;\n  width: 100%;\n  background-color: #fff;\n  box-shadow: 0 1px 5px -2px rgba(0, 0, 0, 0.5);\n  border-radius: 0;\n\n  > ul {\n    margin: 0;\n    padding: 0;\n    list-style: none;\n    line-height: 1.9;\n\n    > li {\n      padding: 0 10px;\n      cursor: pointer;\n      &:hover {\n        background-color: #eeeeee;\n      }\n\n      &.active {\n        background-color: #f2f2f2;\n        &:hover {\n          background-color: #e0e0e0;\n        }\n      }\n    }\n  }\n"], ["\n  position: absolute;\n  top: 100%;\n  left: 0px;\n  width: 100%;\n  background-color: #fff;\n  box-shadow: 0 1px 5px -2px rgba(0, 0, 0, 0.5);\n  border-radius: 0;\n\n  > ul {\n    margin: 0;\n    padding: 0;\n    list-style: none;\n    line-height: 1.9;\n\n    > li {\n      padding: 0 10px;\n      cursor: pointer;\n      &:hover {\n        background-color: #eeeeee;\n      }\n\n      &.active {\n        background-color: #f2f2f2;\n        &:hover {\n          background-color: #e0e0e0;\n        }\n      }\n    }\n  }\n"])));
...
var Search = /** @class */ (function (_super) {
    ...
    function Search(props) {
        var _this = _super.call(this, props) || this;
        _this.onSearch = debounce(_this.debouncedSearch.bind(_this), _this.props.debounceTime);
    ...
    Search.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(InputGroup, { compact: true },
                rootAssetSelect && (React.createElement(RootAssetSelectStyled, { onAssetSelected: this.onAssetSelected, assetId: assetId, strings: {
                        loading: rootAssetSelectLoading,
                        all: rootAssetSelectAll,
                    }, styles: {
                        select: styles && styles.rootAssetSelect,
                    } })),
                advancedSearchQuery ? (React.createElement(React.Fragment, null,
                    React.createElement(ChangeSearchButton, { style: styles && styles.advancedSearchButton, type: "primary", onClick: this.onFilterIconClick }, changeSearch),
                    React.createElement(Button, { htmlType: "button", onClick: this.onModalCancel }, clear))) : (React.createElement(React.Fragment, null, advancedSearch ? (React.createElement(Input$1, { placeholder: searchPlaceholder, disabled: !!advancedSearchQuery, value: query, onChange: this.onSearchQueryInput, allowClear: true, onBlur: this.onSearchBlurBounded, onKeyDown: this.onKeyDown, suffix: this.toggleInputIcon('filter', query, this.onFilterIconClick) })) : (React.createElement(Input$1, { placeholder: searchPlaceholder, disabled: !!advancedSearchQuery, value: query, onChange: this.onSearchQueryInput, allowClear: true, onBlur: this.onSearchBlurBounded, onKeyDown: this.onKeyDown, suffix: this.toggleInputIcon('search', query) })))),
                this.renderLiveSearch(lang)),
            React.createElement(Modal, { visible: isModalOpen, onCancel: this.onModalCancel, bodyStyle: styles && styles.advancedSearch && styles.advancedSearch.modalBody, footer: [
                    React.createElement(Button, { htmlType: "button", key: "cancel", onClick: this.onModalCancel, style: styles &&
                            styles.advancedSearch &&
                            styles.advancedSearch.clearButton }, clear),
                    React.createElement(Button, { htmlType: "button", key: "search", type: "primary", onClick: this.onModalOk, style: styles &&
                            styles.advancedSearch &&
                            styles.advancedSearch.searchButton }, search),
                ] },
                React.createElement(SearchFormHOC, { value: advancedSearchQuery, onPressEnter: this.onModalOk, onChange: this.onSearchChange, styles: styles &&
                        styles.advancedSearch &&
    ...
    Search.prototype.renderLiveSearch = function (strings) {
        ...
        var list = liveSearchResults.length ? (liveSearchResults.map(function (item, index) { return (React.createElement("li", { onMouseDown: function () { return _this.onLiveSearchClick(item); }, key: index, className: cursor === index ? 'active' : undefined, style: styles &&
                styles.searchResultList &&
                styles.searchResultList.listItem }, item.name || 'NaN')); })) : (React.createElement("li", null,
            React.createElement("i", null, emptyLiveSearch)));
        return (React.createElement(LiveSearchWrapper, { style: styles && styles.searchResultList && styles.searchResultList.container },
            React.createElement("ul", { "data-id": 'live-search-list' }, list)));
    };
    Search.prototype.toggleInputIcon = function (iconType, searchQuery, onClick) {
        var loading = this.props.loading;
        return searchQuery ? (loading ? (React.createElement(Icon, { type: "loading", style: { marginLeft: 8 } })) : null) : (React.createElement(Icon, { type: iconType, style: { opacity: 0.6, marginLeft: 8 }, onClick: onClick }));
    };
...
var AssetSearch = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Assets.search(assetQuery)];
                    case 2:
                        items = (_a.sent()).items;
    ...
    AssetSearch.prototype.render = function () {
        ...
        return (React.createElement(Search, { liveSearch: true, onSearch: this.onSearch, liveSearchResults: items, onLiveSearchSelect: onLiveSearchSelect, strings: resultStrings, loading: loading, rootAssetSelect: rootAssetSelect, advancedSearch: advancedSearch, styles: styles }));
    };
...
var AssetTree = /** @class */ (function (_super) {
    ...
    function AssetTree(props) {
        ...
        _this.renderTreeNode = function (nodes) {
            return nodes.map(function (item) {
                if (item.children) {
                    return (React.createElement(TreeNode, { title: item.title, key: item.key, dataRef: item }, _this.renderTreeNode(item.children)));
                }
                return React.createElement(TreeNode, { title: item.title, key: item.key, dataRef: item });
            });
        };
    ...
    AssetTree.prototype.render = function () {
        ...
        return (React.createElement(Tree, { loadData: this.onLoadData, onSelect: function (_, e) { return _this.onSelectNode(e.node.props.dataRef); }, expandedKeys: Object.keys(expandedKeys), onExpand: this.onExpand }, this.renderTreeNode(treeData)));
    };
    return AssetTree;
}(Component));
...
var ComplexString = function (props) {
    ...
    return React.createElement("p", null, resultString);
};

var EventTitle = styled.div(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  font-size: 1.4rem;\n  padding-bottom: 16px;\n"], ["\n  font-size: 1.4rem;\n  padding-bottom: 16px;\n"])));
var EventType = styled.div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  font-size: 1.2rem;\n  color: #40a9ff;\n  padding-bottom: 8px;\n"], ["\n  font-size: 1.2rem;\n  color: #40a9ff;\n  padding-bottom: 8px;\n"])));
var EventDetailsBlock = styled.div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  font-size: 1.1rem;\n  padding-bottom: 16px;\n  p {\n    margin: 0;\n  }\n"], ["\n  font-size: 1.1rem;\n  padding-bottom: 16px;\n  p {\n    margin: 0;\n  }\n"])));
var Container$2 = styled.div(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  color: rgba(0, 0, 0, 0.45);\n  padding: 16px;\n  width: 300px;\n  background: white;\n  border-radius: 4px;\n  border: 1px solid #eee;\n  margin-top: 32px;\n"], ["\n  color: rgba(0, 0, 0, 0.45);\n  padding: 16px;\n  width: 300px;\n  background: white;\n  border-radius: 4px;\n  border: 1px solid #eee;\n  margin-top: 32px;\n"])));
...
var EventPreviewView = function (_a) {
    ...
    return (React.createElement(Container$2, { key: "container", style: styles.wrapper },
        React.createElement(EventType, { style: styles.eventType }, [
            hideProperties.includes('type') ? '' : type,
            hideProperties.includes('subtype') ? '' : subtype,
        ]
            .filter(Boolean)
            .join(' / ')),
        !hideProperties.includes('description') && (React.createElement(EventTitle, { style: styles.description }, description || noDescription)),
        React.createElement(EventDetailsBlock, { style: styles.times },
            !hideProperties.includes('startTime') && (React.createElement("p", null,
                start,
                ": ",
                startDate)),
            !hideProperties.includes('endTime') && (React.createElement("p", null,
                end,
                ": ",
                endDate))),
        !hideProperties.includes('metadata') && (React.createElement(EventDetailsBlock, { style: styles.metadata },
            React.createElement(ComplexString, { input: metadataSummary, count: metadataCount }))),
        onShowDetails && (React.createElement(Button, { htmlType: "button", type: "primary", onClick: function () { return onShowDetails(event); }, style: styles.button }, details))));
};
var templateObject_1$f, templateObject_2$a, templateObject_3$7, templateObject_4$5;

var SpinContainer$2 = styled.div(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n  display: flex;\n  width: 300px;\n  align-items: center;\n  justify-content: center;\n"], ["\n  display: flex;\n  width: 300px;\n  align-items: center;\n  justify-content: center;\n"])));
var LoadingSpinner = function () { return (React.createElement(SpinContainer$2, null,
    React.createElement(Spin, null))); };
var EventPreview = /** @class */ (function (_super) {
    ...
    EventPreview.prototype.loadEvent = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Events.retrieve(this.props.eventId)];
                    case 1:
                        event = _a.sent();
    ...
    EventPreview.prototype.render = function () {
        ...
        if (!event) {
            return hideLoadingSpinner ? null : React.createElement(LoadingSpinner, null);
        }
        return (React.createElement(EventPreviewView, { styles: styles, event: event, onShowDetails: onShowDetails, hideProperties: hideProperties, strings: strings }));
    };
    return EventPreview;
}(React.Component));
...
function createViewer(_a) {
    ...
    var viewer = new Cognite3DViewer({ domElement: domElement });
    var listeners = (_b = {},
        _b[progress] = [],
        _b[complete] = [],
        _b[error] = [],
...
var Model3DViewer = /** @class */ (function (_super) {
    ...
    function Model3DViewer(props) {
        var _this = _super.call(this, props) || this;
        _this.disposeCalls = [];
        _this.divWrapper = React.createRef();
    ...
    Model3DViewer.prototype.render = function () {
        return (React.createElement(React.Fragment, null,
            React.createElement("input", { type: "text", onBlur: this.onBlur, onFocus: this.onFocus, ref: this.inputWrapper, style: { opacity: 0, position: 'absolute', pointerEvents: 'none' } }),
            React.createElement("div", { style: { width: '100%', height: '100%', fontSize: 0 }, ref: this.divWrapper })));
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ThreeD.listAssetMappings(modelId, revisionId, {
                                assetId: assetId,
                            })];
                    case 1:
                        items = (_b.sent()).items;
 ...
 */
var StyledOdometer = styled.div(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  .odometer.odometer-auto-theme,\n  .odometer.odometer-theme-default {\n    display: inline-block;\n    vertical-align: middle;\n    position: relative;\n  }\n  .odometer.odometer-auto-theme .odometer-digit,\n  .odometer.odometer-theme-default .odometer-digit {\n    display: inline-block;\n    vertical-align: middle;\n    position: relative;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-digit-spacer,\n  .odometer.odometer-theme-default .odometer-digit .odometer-digit-spacer {\n    display: inline-block;\n    vertical-align: middle;\n    visibility: hidden;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-digit-inner,\n  .odometer.odometer-theme-default .odometer-digit .odometer-digit-inner {\n    text-align: left;\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    overflow: hidden;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-ribbon,\n  .odometer.odometer-theme-default .odometer-digit .odometer-ribbon {\n    display: block;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-ribbon-inner,\n  .odometer.odometer-theme-default .odometer-digit .odometer-ribbon-inner {\n    display: block;\n    backface-visibility: hidden;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-value,\n  .odometer.odometer-theme-default .odometer-digit .odometer-value {\n    display: block;\n    transform: translateZ(0);\n  }\n  .odometer.odometer-auto-theme\n    .odometer-digit\n    .odometer-value.odometer-last-value,\n  .odometer.odometer-theme-default\n    .odometer-digit\n    .odometer-value.odometer-last-value {\n    position: absolute;\n  }\n  .odometer.odometer-auto-theme.odometer-animating-up .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-up\n    .odometer-ribbon-inner {\n    transition: transform 2s;\n  }\n  .odometer.odometer-auto-theme.odometer-animating-up.odometer-animating\n    .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-up.odometer-animating\n    .odometer-ribbon-inner {\n    transform: translateY(-100%);\n  }\n  .odometer.odometer-auto-theme.odometer-animating-down .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-down\n    .odometer-ribbon-inner {\n    transform: translateY(-100%);\n  }\n  .odometer.odometer-auto-theme.odometer-animating-down.odometer-animating\n    .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-down.odometer-animating\n    .odometer-ribbon-inner {\n    transition: transform 2s;\n    transform: translateY(0);\n  }\n\n  .odometer.odometer-auto-theme,\n  .odometer.odometer-theme-default {\n    font-family: 'Helvetica Neue', sans-serif;\n    line-height: 1.1em;\n  }\n  .odometer.odometer-auto-theme .odometer-value,\n  .odometer.odometer-theme-default .odometer-value {\n    text-align: center;\n  }\n"], ["\n  .odometer.odometer-auto-theme,\n  .odometer.odometer-theme-default {\n    display: inline-block;\n    vertical-align: middle;\n    position: relative;\n  }\n  .odometer.odometer-auto-theme .odometer-digit,\n  .odometer.odometer-theme-default .odometer-digit {\n    display: inline-block;\n    vertical-align: middle;\n    position: relative;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-digit-spacer,\n  .odometer.odometer-theme-default .odometer-digit .odometer-digit-spacer {\n    display: inline-block;\n    vertical-align: middle;\n    visibility: hidden;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-digit-inner,\n  .odometer.odometer-theme-default .odometer-digit .odometer-digit-inner {\n    text-align: left;\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    overflow: hidden;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-ribbon,\n  .odometer.odometer-theme-default .odometer-digit .odometer-ribbon {\n    display: block;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-ribbon-inner,\n  .odometer.odometer-theme-default .odometer-digit .odometer-ribbon-inner {\n    display: block;\n    backface-visibility: hidden;\n  }\n  .odometer.odometer-auto-theme .odometer-digit .odometer-value,\n  .odometer.odometer-theme-default .odometer-digit .odometer-value {\n    display: block;\n    transform: translateZ(0);\n  }\n  .odometer.odometer-auto-theme\n    .odometer-digit\n    .odometer-value.odometer-last-value,\n  .odometer.odometer-theme-default\n    .odometer-digit\n    .odometer-value.odometer-last-value {\n    position: absolute;\n  }\n  .odometer.odometer-auto-theme.odometer-animating-up .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-up\n    .odometer-ribbon-inner {\n    transition: transform 2s;\n  }\n  .odometer.odometer-auto-theme.odometer-animating-up.odometer-animating\n    .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-up.odometer-animating\n    .odometer-ribbon-inner {\n    transform: translateY(-100%);\n  }\n  .odometer.odometer-auto-theme.odometer-animating-down .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-down\n    .odometer-ribbon-inner {\n    transform: translateY(-100%);\n  }\n  .odometer.odometer-auto-theme.odometer-animating-down.odometer-animating\n    .odometer-ribbon-inner,\n  .odometer.odometer-theme-default.odometer-animating-down.odometer-animating\n    .odometer-ribbon-inner {\n    transition: transform 2s;\n    transform: translateY(0);\n  }\n\n  .odometer.odometer-auto-theme,\n  .odometer.odometer-theme-default {\n    font-family: 'Helvetica Neue', sans-serif;\n    line-height: 1.1em;\n  }\n  .odometer.odometer-auto-theme .odometer-value,\n  .odometer.odometer-theme-default .odometer-value {\n    text-align: center;\n  }\n"])));
var templateObject_1$h;

var HELLIP = String.fromCharCode(0x02026);
var Link = styled.a(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  color: 'white';\n  display: 'inherit';\n"], ["\n  color: 'white';\n  display: 'inherit';\n"])));
var Tag = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  background: ", ";\n  border-radius: 30px;\n  color: white;\n  display: flex;\n  white-space: nowrap;\n  padding: 6px 4px;\n  transition: 0.3s all;\n  transform-origin: 24px 50%;\n  @media screen and (max-width: 1000px) {\n    transform: scale(0.75);\n  }\n"], ["\n  background: ", ";\n  border-radius: 30px;\n  color: white;\n  display: flex;\n  white-space: nowrap;\n  padding: 6px 4px;\n  transition: 0.3s all;\n  transform-origin: 24px 50%;\n  @media screen and (max-width: 1000px) {\n    transform: scale(0.75);\n  }\n"])), function (props) { return props.color; });
var TagValue = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  font-size: 1.4rem;\n  display: flex;\n  position: relative;\n  top: -2px;\n"], ["\n  font-size: 1.4rem;\n  display: flex;\n  position: relative;\n  top: -2px;\n"])));
var TagUnit = styled.div(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  opacity: 0.8;\n  font-size: 0.8rem;\n  margin: 4px;\n"], ["\n  opacity: 0.8;\n  font-size: 0.8rem;\n  margin: 4px;\n"])));
var TagSettings = styled.div(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  color: white;\n  font-size: 1.1rem;\n  margin: auto 8px;\n  cursor: pointer;\n  padding-right: 4px;\n"], ["\n  color: white;\n  font-size: 1.1rem;\n  margin: auto 8px;\n  cursor: pointer;\n  padding-right: 4px;\n"])));
var TagName = styled.div(templateObject_6$2 || (templateObject_6$2 = __makeTemplateObject(["\n  color: white;\n  position: absolute;\n  bottom: 100%;\n  margin-bottom: 0;\n  font-size: 0.8rem;\n  font-weight: bold;\n  padding: 6px 12px;\n  white-space: nowrap;\n  border-radius: 30px;\n  background: ", ";\n  transition: 0.3s margin-right, 0.3s opacity, 0.3s margin-bottom;\n  opacity: 0;\n  right: auto;\n  margin-right: 0;\n  pointer-events: none;\n\n  &.hovering {\n    opacity: 1;\n    margin-bottom: 4px;\n  }\n  &.flipped {\n    transform: rotate(180deg);\n    margin-right: -42px;\n  }\n"], ["\n  color: white;\n  position: absolute;\n  bottom: 100%;\n  margin-bottom: 0;\n  font-size: 0.8rem;\n  font-weight: bold;\n  padding: 6px 12px;\n  white-space: nowrap;\n  border-radius: 30px;\n  background: ", ";\n  transition: 0.3s margin-right, 0.3s opacity, 0.3s margin-bottom;\n  opacity: 0;\n  right: auto;\n  margin-right: 0;\n  pointer-events: none;\n\n  &.hovering {\n    opacity: 1;\n    margin-bottom: 4px;\n  }\n  &.flipped {\n    transform: rotate(180deg);\n    margin-right: -42px;\n  }\n"])), function (props) { return props.color; });
var TagDescription = styled.div(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  color: white;\n  position: absolute;\n  bottom: 100%;\n  font-size: 0.7rem;\n  padding: 6px 12px;\n  white-space: nowrap;\n  border-radius: 30px;\n  background: ", ";\n  transition: 0.3s margin-right, 0.3s opacity, 0.3s margin-bottom;\n  opacity: 0;\n  margin-bottom: 36px;\n  right: auto;\n  margin-right: 0;\n  pointer-events: none;\n\n  &.hovering {\n    opacity: 1;\n    margin-bottom: 40px;\n  }\n  &.flipped {\n    transform: rotate(180deg);\n    margin-right: -42px;\n  }\n"], ["\n  color: white;\n  position: absolute;\n  bottom: 100%;\n  font-size: 0.7rem;\n  padding: 6px 12px;\n  white-space: nowrap;\n  border-radius: 30px;\n  background: ", ";\n  transition: 0.3s margin-right, 0.3s opacity, 0.3s margin-bottom;\n  opacity: 0;\n  margin-bottom: 36px;\n  right: auto;\n  margin-right: 0;\n  pointer-events: none;\n\n  &.hovering {\n    opacity: 1;\n    margin-bottom: 40px;\n  }\n  &.flipped {\n    transform: rotate(180deg);\n    margin-right: -42px;\n  }\n"])), function (props) { return props.color; });
var TagError = styled.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  color: white;\n  position: absolute;\n  top: 100%;\n  opacity: 1;\n  align-items: center;\n  font-size: 0.7rem;\n  padding: 6px 12px;\n  margin-top: 6px;\n  white-space: nowrap;\n  border-radius: 30px;\n  background-color: ", ";\n  transition: 0.3s margin-right, 0.3s opacity, 0.3s margin-bottom;\n  opacity: 0;\n  right: auto;\n  margin-right: 0;\n  margin-top: 6px;\n\n  & > p {\n    margin: 2px;\n  }\n\n  &.hovering {\n    opacity: 1;\n    margin-top: 10;\n  }\n  &.flipped {\n    transform: rotate(180deg);\n    margin-right: -42px;\n  }\n"], ["\n  color: white;\n  position: absolute;\n  top: 100%;\n  opacity: 1;\n  align-items: center;\n  font-size: 0.7rem;\n  padding: 6px 12px;\n  margin-top: 6px;\n  white-space: nowrap;\n  border-radius: 30px;\n  background-color: ", ";\n  transition: 0.3s margin-right, 0.3s opacity, 0.3s margin-bottom;\n  opacity: 0;\n  right: auto;\n  margin-right: 0;\n  margin-top: 6px;\n\n  & > p {\n    margin: 2px;\n  }\n\n  &.hovering {\n    opacity: 1;\n    margin-top: 10;\n  }\n  &.flipped {\n    transform: rotate(180deg);\n    margin-right: -42px;\n  }\n"])), function (_a) {
...
var DraggableBox = /** @class */ (function (_super) {
    ...
    function DraggableBox(props) {
        ...
        _this.fetchTimeSeries = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connectPromiseToUnmountState(this, TimeSeries.retrieve(id, true))];
                    case 1:
                        timeserie = _a.sent();
                        this.setState({
                            tag: timeserie,
        ...
        _this.updateValue = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connectPromiseToUnmountState(this, Datapoints.retrieveLatest(this.state.tag.name))];
                    case 1:
                        data = _a.sent();
                        if (!data) {
                            this.setState({
        ...
        _this.getPercentDiff = function () {
            ...
            if (min !== undefined && value < min) {
                ...
                return (React.createElement(ComplexString, { input: strings.underPercentage, percent: percent, min: min }));
            }
            if (max !== undefined && value > max) {
                var percent = (((value - max) / max) * 100).toFixed(2);
                return (React.createElement(ComplexString, { input: strings.overPercentage, percent: percent, max: max }));
            }
            return '';
        };
        _this.state = {
    ...
    DraggableBox.prototype.renderValue = function () {
        ...
        return (React.createElement(StyledOdometer, { key: "odometer" },
            React.createElement(Odometer, { value: numeral(+value).format('0,0.[000000]'), duration: 250 })));
    };
    DraggableBox.prototype.renderTag = function () {
        var valueComponent = this.renderValue();
        var unit = (this.state.tag || { unit: undefined }).unit;
        return (React.createElement(Tag, { color: this.props.color, onMouseOver: this.onMouseOver, onMouseLeave: this.onMouseLeave, onClick: this.handleClick },
            this.props.isDraggable &&
                this.props.connectDragSource(React.createElement("div", { style: __assign({}, handleStyles, { backgroundColor: this.isValid()
                            ? 'white'
                            : this.props.alertColor }), onDoubleClick: this.onDragHandleDoubleClick })),
            React.createElement(TagValue, { style: this.props.flipped ? flipStyle : {} }, this.props.onLinkClick ? (React.createElement(Link, { style: {
                    color: 'white',
                    display: 'inherit',
                }, onClick: this.handleLinkClick },
                valueComponent,
                unit && React.createElement(TagUnit, null, unit))) : (React.createElement(React.Fragment, null,
                valueComponent,
                unit && React.createElement(TagUnit, { key: "unit" }, unit)))),
            this.props.onSettingsClick ? (React.createElement(TagSettings, { onClick: this.handleSettingsClick },
                React.createElement(Icon, { type: "setting" }))) : (React.createElement("div", { style: { width: 16, height: 16 } }))));
    };
    DraggableBox.prototype.renderError = function () {
        ...
        return !this.isValid() ? (React.createElement(TagError, { alertColor: alertColor, color: color, className: (hovering || sticky ? 'hovering' : '') + " " + (flipped ? 'flipped' : '') }, this.getPercentDiff())) : null;
    };
    DraggableBox.prototype.render = function () {
        ...
        return (React.createElement("div", { style: {
            ...
            name && (React.createElement(TagName, { color: color, className: (hovering || sticky ? 'hovering' : '') + " " + (flipped ? 'flipped' : '') }, name)),
            description && (React.createElement(TagDescription, { color: color, className: (hovering || sticky ? 'hovering' : '') + " " + (flipped ? 'flipped' : '') }, description)),
            this.renderError(),
            this.renderTag()));
    };
...
var DraggableBox$1 = DragSource(DragTargets.Point, boxSource, function (connect, monitor) { return ({
...
var DraggablePoint = /** @class */ (function (_super) {
    ...
    DraggablePoint.prototype.render = function () {
        ...
        return connectDragPreview(connectDragSource(React.createElement("div", { style: {
                position: 'absolute',
                left: left,
                top: top,
            ...
            React.createElement("svg", { width: 24, height: 24 },
                React.createElement("circle", { cx: 12, cy: 12, r: 7, fill: color }),
                React.createElement("circle", { cx: 12, cy: 12, r: 10, stroke: color, fill: "transparent" })))));
    };
    return DraggablePoint;
}(Component));
var DraggablePoint$1 = DragSource(DragTargets.Box, boxSource$1, function (connect, monitor) { return ({
    connectDragSource: connect.dragSource(),
    connectDragPreview: connect.dragPreview(),
    isDragging: monitor.isDragging(),
}); })(DraggablePoint);
...
var SvgLine = function (_a) {
    ...
    return (React.createElement("svg", { style: {
        ...
        React.createElement("g", null,
            React.createElement("line", { x1: box.left, y1: box.top, x2: box.pointer.left, y2: box.pointer.top, style: { stroke: box.color, strokeWidth: 2 } }))));
};
...
var SensorOverlay = /** @class */ (function (_super) {
    ...
    function SensorOverlay(props) {
        ...
        _this.notifyParentOnPositionChange = function (id) {
            if (_this.props.onSensorPositionChange) {
                ...
                if (box) {
                    _this.props.onSensorPositionChange(id, omit(box, ['id', 'defaultSlot']));
                }
            }
        };
        ...
        return props.timeseriesIds.map(function (id) {
            ...
            if (oldBox) {
                ...
                if (typeof defaultSlot === 'number') {
                    closedSlots.splice(sortedIndex(closedSlots, defaultSlot), 0, defaultSlot);
                }
    ...
    SensorOverlay.prototype.render = function () {
        ...
        return this.props.connectDropTarget(React.createElement("div", { style: {
                position: 'relative',
                display: 'block',
            ...
            this.state.boxes.map(function (box) {
                ...
                return (React.createElement(React.Fragment, { key: box.id },
                    ...
                    React.createElement(DraggablePoint$1, { id: box.id, left: box.pointer.left * size.width, top: box.pointer.top * size.height, color: color, isDraggable: _this.props.isPointerDraggable, onClick: _this.props.onClick, onDragHandleDoubleClick: _this.onAnchorDoubleClick })));
            })));
    };
...
var WrappedSensorOverlay = DropTarget([DragTargets.Box, DragTargets.Point], boxTarget, function (connect) { return ({
    connectDropTarget: connect.dropTarget(),
}); })(SensorOverlay);
var SizeWrapper = withSize({ monitorHeight: true })(WrappedSensorOverlay);
var FinalSensorOverlay = DragDropContext(HTML5Backend)(SizeWrapper);
...
var TenantSelector = /** @class */ (function (_super) {
    ...
    TenantSelector.prototype.renderAdvancedOptions = function () {
        ...
        var inputs = keys.map(function (option) {
            return (React.createElement(Form.Item, { key: option },
                React.createElement(Input, { style: styles && styles.input, name: option, onChange: function (e) { return _this.onAdvancedOptionChange(e, option); }, value: advanced[option], placeholder: option })));
        });
        return (React.createElement(CollapseWrapper, { bordered: false, "data-id": "collapse-container", style: styles && styles.collapseWrapper },
            React.createElement(Panel$1, { key: '0', header: 'Advanced options' }, inputs)));
    };
    TenantSelector.prototype.render = function () {
        ...
        return (React.createElement(LoginWrapper, { style: styles && styles.wrapper },
            React.createElement(Title, { style: styles && styles.title }, title),
            header && typeof header !== 'string' ? (header) : (React.createElement(SubTitle, { style: styles && styles.subTitle }, header || 'Enter your company name')),
            React.createElement(Form, null,
                React.createElement(Form.Item, __assign({ hasFeedback: true }, formItemProps),
                    React.createElement(Input, { style: styles && styles.input, "data-id": "tenant-input", autoFocus: true, onChange: this.onTenantChange, onPressEnter: this.checkTenantValidity, value: tenant, defaultValue: tenant, placeholder: placeholder || 'cognite' })),
                this.renderAdvancedOptions()),
            React.createElement(LoginButton, { style: styles && styles.button, htmlType: "button", disabled: checkingValidity || invalidTenant || tenant === '', onClick: this.checkTenantValidity }, checkingValidity ? React.createElement(Spin, { size: "small" }) : loginText || 'Login')));
    };
...
var LoginWrapper = styled.div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: initial;\n  flex-direction: column;\n  -webkit-box-pack: start;\n  justify-content: flex-start;\n  max-width: 400px;\n  box-shadow: ", ";\n  background-color: ", ";\n  margin: auto;\n  padding: 45px;\n  overflow: auto;\n"], ["\n  display: flex;\n  flex-wrap: initial;\n  flex-direction: column;\n  -webkit-box-pack: start;\n  justify-content: flex-start;\n  max-width: 400px;\n  box-shadow: ", ";\n  background-color: ", ";\n  margin: auto;\n  padding: 45px;\n  overflow: auto;\n"])), function (_a) {
    var theme = _a.theme;
...
var Title = styled.h1(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  font-weight: bold;\n  color: ", ";\n"], ["\n  font-weight: bold;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.gearbox.textColor;
});
Title.defaultProps = {
...
var SubTitle = styled.h3(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.gearbox.textColor;
});
...
var Input = styled(function (props) { return React.createElement(Input$1, __assign({}, props)); })(templateObject_4$7 || (templateObject_4$7 = __makeTemplateObject(["\n  && {\n    border: none;\n    background-color: ", ";\n    font-weight: bold;\n    border-radius: 0;\n    height: 48px;\n    border-bottom: 2px solid ", ";\n    margin-bottom: 8px;\n    color: ", ";\n    &:focus,\n    &:active {\n      box-shadow: none;\n      border-bottom: 2px solid ", ";\n    }\n    &:hover {\n      border-bottom: 2px solid ", ";\n    }\n    &::placeholder {\n      color: ", " !important;\n    }\n  }\n"], ["\n  && {\n    border: none;\n    background-color: ", ";\n    font-weight: bold;\n    border-radius: 0;\n    height: 48px;\n    border-bottom: 2px solid ", ";\n    margin-bottom: 8px;\n    color: ", ";\n    &:focus,\n    &:active {\n      box-shadow: none;\n      border-bottom: 2px solid ", ";\n    }\n    &:hover {\n      border-bottom: 2px solid ", ";\n    }\n    &::placeholder {\n      color: ", " !important;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var LoginButton = styled(function (props) { return React.createElement(Button, __assign({}, props)); })(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  font-weight: bold;\n  text-transform: uppercase;\n  border-radius: 0;\n  min-height: 45px;\n  margin: 15px 0;\n  border-color: ", ";\n\n  &:not([disabled]) {\n    cursor: pointer;\n    background-color: ", ";\n    border-color: ", ";\n    color: ", ";\n    &:hover {\n      color: ", ";\n      border-color: ", ";\n      background-color: ", ";\n    }\n  }\n\n  &:disabled,\n  &:disabled:hover {\n    border-color: ", " !important;\n    background-color: ", " !important;\n    color: ", ";\n  }\n"], ["\n  font-weight: bold;\n  text-transform: uppercase;\n  border-radius: 0;\n  min-height: 45px;\n  margin: 15px 0;\n  border-color: ", ";\n\n  &:not([disabled]) {\n    cursor: pointer;\n    background-color: ", ";\n    border-color: ", ";\n    color: ", ";\n    &:hover {\n      color: ", ";\n      border-color: ", ";\n      background-color: ", ";\n    }\n  }\n\n  &:disabled,\n  &:disabled:hover {\n    border-color: ", " !important;\n    background-color: ",
    " !important;\n    color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var CollapseWrapper = styled(Collapse)(templateObject_6$3 || (templateObject_6$3 = __makeTemplateObject(["\n  .ant-collapse-item {\n    border-bottom: none !important;\n  }\n  .ant-collapse-content {\n    background-color: ", " !important;\n  }\n  .ant-collapse-header {\n    font-size: 1.17em;\n    font-weight: 500;\n    color: ", " !important;\n    padding-left: 20px !important;\n    background-color: ", ";\n\n    .ant-collapse-arrow {\n      left: 0 !important;\n      color: ", " !important;\n    }\n  }\n  .ant-collapse-content-box {\n    padding: 5px 0 0 0 !important;\n  }\n"], ["\n  .ant-collapse-item {\n    border-bottom: none !important;\n  }\n  .ant-collapse-content {\n    background-color: ", " !important;\n  }\n  .ant-collapse-header {\n    font-size: 1.17em;\n    font-weight: 500;\n    color: ", " !important;\n    padding-left: 20px !important;\n    background-color: ", ";\n\n    .ant-collapse-arrow {\n      left: 0 !important;\n      color: ", " !important;\n    }\n  }\n  .ant-collapse-content-box {\n    padding: 5px 0 0 0 !important;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.gearbox.containerColor;
}, function (_a) {
    var theme = _a.theme;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, connectPromiseToUnmountState(this, TimeSeries.retrieve(this.props.timeseriesId, true))];
                        case 1:
                            timeseries = _a.sent();
                            this.setState({
                                isLoading: false,
        ...
        class_1.prototype.render = function () {
            ...
            if (isLoading) {
                return (React.createElement(SpinnerContainer, null,
                    React.createElement(LoadingOverlay, { isLoading: true, backgroundColor: 'none' })));
            }
            if (timeseries) {
                return (React.createElement(WrapperComponent, __assign({}, this.props, { timeseries: timeseries })));
            }
            return null;
        };
        return class_1;
...
var SpinnerContainer = styled.div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  position: relative;\n  height: 300px;\n"], ["\n  position: relative;\n  height: 300px;\n"])));
...
var DetailCheckbox = function (_a) {
    ...
    return (React.createElement(Container$3, { className: className, onClick: disabled ? null : onContainerClick },
        ...
        checkable && (React.createElement(Checkbox, { checked: checked, disabled: disabled, onClick: function (e) { return e.preventDefault(); } }))));
};
DetailCheckbox.defaultProps = defaultProps;
var templateObject_1$l;

var Wrapper$4 = styled.div(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  flex-directoin: row;\n  margin-bottom: 8px;\n"], ["\n  flex-directoin: row;\n  margin-bottom: 8px;\n"])));
var SelectedItems = /** @class */ (function (_super) {
    ...
    SelectedItems.prototype.render = function () {
        ...
        return (React.createElement(Wrapper$4, null,
            ...
            selectedItems &&
                selectedItems.map(function (item) { return (React.createElement(Tag$1, { key: item.id, onClose: function () { return onItemClose(item); }, closable: true, color: getColorByString(item.id.toString()) }, item.name || '')); })));
    };
...
var TagList = styled.div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n  margin-top: 8px;\n  width: 100%;\n  height: auto;\n  overflow: auto;\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n  margin-top: 8px;\n  width: 100%;\n  height: auto;\n  overflow: auto;\n"])));
var CenteredSpin = styled(Spin)(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  &.ant-spin-spinning {\n    min-height: 25px;\n    height: 100%;\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n"], ["\n  &.ant-spin-spinning {\n    min-height: 25px;\n    height: 100%;\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n"])));
var ButtonRow = styled.div(templateObject_4$8 || (templateObject_4$8 = __makeTemplateObject(["\n  margin-top: 5px;\n"], ["\n  margin-top: 5px;\n"])));
var SelectNoneButton = styled(function (props) { return (React.createElement(Button, __assign({}, props))); })(templateObject_5$5 || (templateObject_5$5 = __makeTemplateObject(["\n  margin-left: 10px;\n"], ["\n  margin-left: 10px;\n"])));
...
var TimeseriesSearch = /** @class */ (function (_super) {
    ...
    function TimeseriesSearch(props) {
        ...
        _this.fetchTimeseries = debounce(_this.fetchTimeseries, 200, {
            leading: false,
            trailing: true,
        });
        return _this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TimeSeries.retrieveMultiple(selectedTimeseries)];
                    case 1:
                        timeseries = _a.sent();
    ...
    TimeseriesSearch.prototype.render = function () {
        ...
        return (React.createElement(Wrapper$5, null,
            !hideSelected && (React.createElement(SelectedItems, { selectedItems: selectedTimeseries.map(function (t) { return ({
                    id: t.id,
                    name: t.name,
                }); }), onItemClose: this.onItemClose })),
            React.createElement(Search, { rootAssetSelect: rootAssetSelect, onAssetSelected: this.onSelectAsset, assetId: assetId || 0, onSearch: this.fetchTimeseries, strings: {
            ...
            searchResults.length > 0 && !single ? (React.createElement(ButtonRow, { style: styles && styles.buttonRow },
                React.createElement(Button, { htmlType: "button", onClick: this.onSelectAll, disabled: this.isAllSelected(), style: styles && styles.selectAllButton }, lang.selectAll),
                React.createElement(SelectNoneButton, { htmlType: "button", onClick: this.onSelectNone, disabled: selectedTimeseries.length === 0, style: styles && styles.selectNoneButton }, lang.selectNone))) : null,
            React.createElement(TagList, { style: styles && styles.list },
                fetching ? React.createElement(CenteredSpin, null) : null,
                searchResults.map(function (timeseries, index) { return (React.createElement(DetailCheckbox, { className: "tag-search-result result-" + timeseries.id + " " + (index === cursor ? 'active' : ''), key: "detail-checkbox--" + timeseries.id, title: timeseries.name || timeseries.id.toString(), description: timeseries.description || timeseries.name || 'No description', checkable: !single, checked: _this.isChecked(timeseries.id), onContainerClick: function () { return _this.onTimeSerieClicked(timeseries); }, disabled: !allowStrings && !!timeseries.isString })); }))));
    };
